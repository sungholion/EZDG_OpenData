...
public class DaeguOctoberResidentRegisteredPopulationGenerationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguOctoberResidentRegisteredPopulationGenerationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguOctoberResidentRegisteredPopulationGenerationStatus.class);
    }
}