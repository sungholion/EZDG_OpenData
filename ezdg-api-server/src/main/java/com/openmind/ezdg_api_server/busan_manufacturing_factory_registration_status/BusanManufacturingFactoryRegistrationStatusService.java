...
public class BusanManufacturingFactoryRegistrationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<BusanManufacturingFactoryRegistrationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, BusanManufacturingFactoryRegistrationStatus.class);
    }
}