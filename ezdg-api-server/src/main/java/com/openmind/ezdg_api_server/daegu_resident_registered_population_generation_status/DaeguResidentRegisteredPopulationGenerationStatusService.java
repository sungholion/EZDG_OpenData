...
public class DaeguResidentRegisteredPopulationGenerationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguResidentRegisteredPopulationGenerationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguResidentRegisteredPopulationGenerationStatus.class);
    }
}