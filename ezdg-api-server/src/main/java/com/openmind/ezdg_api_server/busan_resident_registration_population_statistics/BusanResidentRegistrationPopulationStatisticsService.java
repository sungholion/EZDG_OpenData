...
public class BusanResidentRegistrationPopulationStatisticsService {

    private final MongoTemplate mongoTemplate;

    public List<BusanResidentRegistrationPopulationStatistics> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, BusanResidentRegistrationPopulationStatistics.class);
    }
}