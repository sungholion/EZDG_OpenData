...
public class BusanGeneralHospitalStatusService {

    private final MongoTemplate mongoTemplate;

    public List<BusanGeneralHospitalStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, BusanGeneralHospitalStatus.class);
    }
}