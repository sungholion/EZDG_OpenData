...
public class GumiFactoryRegistrationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<GumiFactoryRegistrationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiFactoryRegistrationStatus.class);
    }
}