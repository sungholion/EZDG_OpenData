...
import com.openmind.ezdg_api_server.daegu_tourism_course_information.DaeguTourismCourseInformationService;
import com.openmind.ezdg_api_server.daegu_tourism_course_information.DaeguTourismCourseInformation;
...
@RequestMapping("/daegu_tourism_course_information")
public class DaeguTourismCourseInformationController {

    private final DaeguTourismCourseInformationService service;

    @GetMapping("")
    public List<DaeguTourismCourseInformation> search (
