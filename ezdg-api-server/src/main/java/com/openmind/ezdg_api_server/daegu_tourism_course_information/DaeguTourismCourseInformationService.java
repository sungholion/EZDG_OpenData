...
public class DaeguTourismCourseInformationService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguTourismCourseInformation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguTourismCourseInformation.class);
    }
}