...
public class DaeguAccommodationService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguAccommodation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguAccommodation.class);
    }
}