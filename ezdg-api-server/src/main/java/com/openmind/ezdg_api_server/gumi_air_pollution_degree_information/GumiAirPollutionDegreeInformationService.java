...
public class GumiAirPollutionDegreeInformationService {

    private final MongoTemplate mongoTemplate;

    public List<GumiAirPollutionDegreeInformation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiAirPollutionDegreeInformation.class);
    }
}