...
public class DaeguLocalCompanyInformationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguLocalCompanyInformationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguLocalCompanyInformationStatus.class);
    }
}