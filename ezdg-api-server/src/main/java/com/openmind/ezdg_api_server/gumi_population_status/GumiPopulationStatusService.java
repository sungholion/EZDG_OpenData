...
public class GumiPopulationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<GumiPopulationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiPopulationStatus.class);
    }
}