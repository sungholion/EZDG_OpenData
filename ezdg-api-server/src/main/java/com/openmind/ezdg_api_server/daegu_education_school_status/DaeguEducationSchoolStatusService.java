...
public class DaeguEducationSchoolStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguEducationSchoolStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguEducationSchoolStatus.class);
    }
}