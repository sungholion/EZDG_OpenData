...
import com.openmind.ezdg_api_server.daegu_tourism.DaeguTourismService;
import com.openmind.ezdg_api_server.daegu_tourism.DaeguTourism;
...
@RequestMapping("/daegu_tourism")
public class DaeguTourismController {

    private final DaeguTourismService service;

    @GetMapping("")
    public List<DaeguTourism> search (
