...
public class DaeguTourismService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguTourism> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguTourism.class);
    }
}