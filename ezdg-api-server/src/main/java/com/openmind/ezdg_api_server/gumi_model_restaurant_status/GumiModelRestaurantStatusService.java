...
public class GumiModelRestaurantStatusService {

    private final MongoTemplate mongoTemplate;

    public List<GumiModelRestaurantStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiModelRestaurantStatus.class);
    }
}