...
import com.openmind.ezdg_api_server.gumi_price_information_status.GumiPriceInformationStatusService;
import com.openmind.ezdg_api_server.gumi_price_information_status.GumiPriceInformationStatus;
...
@RequestMapping("/gumi_price_information_status")
public class GumiPriceInformationStatusController {

    private final GumiPriceInformationStatusService service;

    @GetMapping("")
    public List<GumiPriceInformationStatus> search (
