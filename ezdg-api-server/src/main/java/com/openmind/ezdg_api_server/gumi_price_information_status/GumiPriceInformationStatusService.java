...
public class GumiPriceInformationStatusService {

    private final MongoTemplate mongoTemplate;

    public List<GumiPriceInformationStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiPriceInformationStatus.class);
    }
}