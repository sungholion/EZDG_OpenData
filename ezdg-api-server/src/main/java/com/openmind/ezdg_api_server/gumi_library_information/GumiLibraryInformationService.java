...
public class GumiLibraryInformationService {

    private final MongoTemplate mongoTemplate;

    public List<GumiLibraryInformation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiLibraryInformation.class);
    }
}