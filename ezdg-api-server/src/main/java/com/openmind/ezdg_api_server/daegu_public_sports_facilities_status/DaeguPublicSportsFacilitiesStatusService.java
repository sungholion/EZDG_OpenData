...
public class DaeguPublicSportsFacilitiesStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguPublicSportsFacilitiesStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguPublicSportsFacilitiesStatus.class);
    }
}