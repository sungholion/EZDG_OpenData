...
public class BusanProtectionCctvInformationService {

    private final MongoTemplate mongoTemplate;

    public List<BusanProtectionCctvInformation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, BusanProtectionCctvInformation.class);
    }
}