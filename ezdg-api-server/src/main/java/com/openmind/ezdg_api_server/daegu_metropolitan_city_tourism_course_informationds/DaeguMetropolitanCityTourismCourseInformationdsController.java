...
import com.openmind.ezdg_api_server.daegu_metropolitan_city_tourism_course_informationds.DaeguMetropolitanCityTourismCourseInformationdsService;
import com.openmind.ezdg_api_server.daegu_metropolitan_city_tourism_course_informationds.DaeguMetropolitanCityTourismCourseInformationds;
...
@RequestMapping("/daegu_metropolitan_city_tourism_course_informationds")
public class DaeguMetropolitanCityTourismCourseInformationdsController {

    private final DaeguMetropolitanCityTourismCourseInformationdsService service;

    @GetMapping("")
    public List<DaeguMetropolitanCityTourismCourseInformationds> search (
