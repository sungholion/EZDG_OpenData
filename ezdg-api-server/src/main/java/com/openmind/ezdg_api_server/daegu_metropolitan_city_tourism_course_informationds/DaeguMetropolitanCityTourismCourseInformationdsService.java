...
public class DaeguMetropolitanCityTourismCourseInformationdsService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguMetropolitanCityTourismCourseInformationds> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguMetropolitanCityTourismCourseInformationds.class);
    }
}