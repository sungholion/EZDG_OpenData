...
import com.openmind.ezdg_api_server.daegu_metropolitan_city_tourism_course_information_new.DaeguMetropolitanCityTourismCourseInformationNewService;
import com.openmind.ezdg_api_server.daegu_metropolitan_city_tourism_course_information_new.DaeguMetropolitanCityTourismCourseInformationNew;
...
@RestController
@RequestMapping("/daegu_metropolitan_city_tourism_course_information_new")
@RequiredArgsConstructor
public class DaeguMetropolitanCityTourismCourseInformationNewController {
private final DaeguMetropolitanCityTourismCourseInformationNewService service;

    @GetMapping("")
    public List<DaeguMetropolitanCityTourismCourseInformationNew> search(
