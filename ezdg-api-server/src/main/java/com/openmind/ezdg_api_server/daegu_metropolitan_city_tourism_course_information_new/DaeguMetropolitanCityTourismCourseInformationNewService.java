...
public class DaeguMetropolitanCityTourismCourseInformationNewService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguMetropolitanCityTourismCourseInformationNew> search(Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguMetropolitanCityTourismCourseInformationNew.class);
    }
}