...
public class DaeguRestaurantService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguRestaurant> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguRestaurant.class);
    }
}