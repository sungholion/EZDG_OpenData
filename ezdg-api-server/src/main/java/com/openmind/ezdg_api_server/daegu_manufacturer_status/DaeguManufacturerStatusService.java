...
public class DaeguManufacturerStatusService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguManufacturerStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguManufacturerStatus.class);
    }
}