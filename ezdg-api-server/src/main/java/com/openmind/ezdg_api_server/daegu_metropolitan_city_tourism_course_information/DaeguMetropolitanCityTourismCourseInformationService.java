...
public class DaeguMetropolitanCityTourismCourseInformationService {

    private final MongoTemplate mongoTemplate;

    public List<DaeguMetropolitanCityTourismCourseInformation> search(Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, DaeguMetropolitanCityTourismCourseInformation.class);
    }
}