...
public class BusanBeachVisitStatusService {

    private final MongoTemplate mongoTemplate;

    public List<BusanBeachVisitStatus> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, BusanBeachVisitStatus.class);
    }
}