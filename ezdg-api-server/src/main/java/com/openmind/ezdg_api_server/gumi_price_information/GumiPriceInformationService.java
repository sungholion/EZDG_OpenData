...
public class GumiPriceInformationService {

    private final MongoTemplate mongoTemplate;

    public List<GumiPriceInformation> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiPriceInformation.class);
    }
}