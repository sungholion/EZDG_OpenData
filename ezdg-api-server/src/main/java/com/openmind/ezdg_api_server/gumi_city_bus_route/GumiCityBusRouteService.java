...
public class GumiCityBusRouteService {

    private final MongoTemplate mongoTemplate;

    public List<GumiCityBusRoute> search (Map<String, Object> params, int page, int perPage) {
        ...
        return mongoTemplate.find(query, GumiCityBusRoute.class);
    }
}