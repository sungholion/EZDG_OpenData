...
public class GetIncoStat_V2Api {
    ...
    * 공공데이터포털에서 받은 인증키
    */
    public GetIncoStat_V2Api serviceKey(String serviceKey) {
    ...
    * 한 페이지 결과 수
    */
    public GetIncoStat_V2Api numOfRows(String numOfRows) {
        if(queryParams.length() == 0) queryParams.append("?");
        else queryParams.append("&");
    ...
    * 페이지번호
    */
    public GetIncoStat_V2Api pageNo(String pageNo) {
        if(queryParams.length() == 0) queryParams.append("?");
        else queryParams.append("&");
    ...
    * 결과형식(xml/json)
    */
    public GetIncoStat_V2Api resultType(String resultType) {
        if(queryParams.length() == 0) queryParams.append("?");
        else queryParams.append("&");
    ...
    * 법인등록번호
    */
    public GetIncoStat_V2Api crno(String crno) {
        if(queryParams.length() == 0) queryParams.append("?");
        else queryParams.append("&");
    ...
    */
    public GetIncoStat_V2Api bizYear(String bizYear) {
        if(queryParams.length() == 0) queryParams.append("?");
        else queryParams.append("&");
...
public GetIncoStat_V2ApiResponse fetch() throws Exception {
    // API 호출
...
// JSON 파싱
try {
    return objectMapper.readValue(content.toString(), GetIncoStat_V2ApiResponse.class);
    } catch (Exception e) {
    e.printStackTrace();
