...
@Getter
@Setter
public class DeclareRecordPatDetailInfoResponse {
    ...
    public static class Item {
        ...
        StringBuilder sb = new StringBuilder();
            ...
            sb.append("Ipctitle: ").append(this.getIpctitle()).append("\n");
            sb.append("Familypatlist: ").append(this.getFamilypatlist()).append("\n");
            ...
            sb.append("Abst: ").append(this.getAbst()).append("\n");
