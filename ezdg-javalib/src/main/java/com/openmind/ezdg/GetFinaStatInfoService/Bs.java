...
public class Bs {
    ...
    * 한 페이지 결과 수
    */
    public Bs numOfRows(String numOfRows) {
    ...
    * 페이지 번호
    */
    public Bs pageNo(String pageNo) {
    ...
    * 결과형식(xml/json)
    */
    public Bs resultType(String resultType) {
        queryParams.append("&resultType=").append(Encoder.encode(resultType));
        return this;
    }

    public Bs (String serviceKey) {
    ...
    */
    public Bs bizYear(String bizYear) {
    ...
    */
    public BsResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), BsResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
