...
public class searchStay {
    ...
    * 한페이지결과수
    */
    public searchStay numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public searchStay pageNo(Number pageNo) {
    ...
    */
    public searchStay MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public searchStay MobileApp(String MobileApp) {
    ...
    */
    public searchStay _type(String _type) {
    ...
    * 목록구분(Y=목록, N=개수)
    */
    public searchStay listYN(String listYN) {
    ...
    */
    public searchStay arrange(String arrange) {
    ...
    * 지역코드(지역코드조회 참고)
    */
    public searchStay areaCode(String areaCode) {
    ...
    * 시군구코드(지역코드조회 참고)
    */
    public searchStay sigunguCode(String sigunguCode) {
    ...
    * 수정일(형식 :YYYYMMDD)
    */
    public searchStay modifiedtime(String modifiedtime) {
        queryParams.append("&modifiedtime=").append(encode(modifiedtime));
        return this;
    }

    public searchStay (String serviceKey) {
    ...
    * API 호출 및 응답 파싱
    */
    public searchStayResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), searchStayResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
