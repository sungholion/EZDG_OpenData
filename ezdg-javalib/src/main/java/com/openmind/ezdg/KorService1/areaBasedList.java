...
public class areaBasedList {
    ...
    * 한페이지결과수
    */
    public areaBasedList numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public areaBasedList pageNo(Number pageNo) {
    ...
    */
    public areaBasedList MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public areaBasedList MobileApp(String MobileApp) {
    ...
    */
    public areaBasedList _type(String _type) {
    ...
    * 목록구분(Y=목록, N=개수)
    */
    public areaBasedList listYN(String listYN) {
    ...
    */
    public areaBasedList arrange(String arrange) {
    ...
    */
    public areaBasedList contentTypeId(String contentTypeId) {
    ...
    * 지역코드(지역코드조회 참고)
    */
    public areaBasedList areaCode(String areaCode) {
    ...
    * 시군구코드(지역코드조회 참고)
    */
    public areaBasedList sigunguCode(String sigunguCode) {
    ...
    * 대분류(서비스분류코드조회 참고)
    */
    public areaBasedList cat1(String cat1) {
    ...
    * 중분류(서비스분류코드조회 참고)
    */
    public areaBasedList cat2(String cat2) {
    ...
    * 소분류(서비스분류코드조회 참고)
    */
    public areaBasedList cat3(String cat3) {
    ...
    * 수정일(형식 :YYYYMMDD)
    */
    public areaBasedList modifiedtime(String modifiedtime) {
        queryParams.append("&modifiedtime=").append(encode(modifiedtime));
        return this;
    }

    public areaBasedList (String serviceKey) {
    ...
    * API 호출 및 응답 파싱
    */
    public areaBasedListResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), areaBasedListResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
