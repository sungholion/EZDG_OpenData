...
public class detailCommon {
    ...
    */
    public detailCommon MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public detailCommon MobileApp(String MobileApp) {
    ...
    */
    public detailCommon _type(String _type) {
    ...
    * 콘텐츠ID
    */
    public detailCommon contentId(String contentId) {
    ...
    */
    public detailCommon contentTypeId(String contentTypeId) {
    ...
    * 기본정보조회여부( Y,N )
    */
    public detailCommon defaultYN(String defaultYN) {
    ...
    */
    public detailCommon firstImageYN(String firstImageYN) {
    ...
    * 지역코드, 시군구코드조회여부( Y,N )
    */
    public detailCommon areacodeYN(String areacodeYN) {
    ...
    * 대,중,소분류코드조회여부( Y,N )
    */
    public detailCommon catcodeYN(String catcodeYN) {
    ...
    * 주소, 상세주소조회여부( Y,N )
    */
    public detailCommon addrinfoYN(String addrinfoYN) {
    ...
    * 좌표X, Y 조회여부( Y,N )
    */
    public detailCommon mapinfoYN(String mapinfoYN) {
    ...
    * 콘텐츠개요조회여부( Y,N )
    */
    public detailCommon overviewYN(String overviewYN) {
    ...
    * 한페이지결과수
    */
    public detailCommon numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public detailCommon pageNo(Number pageNo) {
        queryParams.append("&pageNo=").append(encode(pageNo));
        return this;
    }

    public detailCommon (String serviceKey) {
    ...
    * API 호출 및 응답 파싱
    */
    public detailCommonResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), detailCommonResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
