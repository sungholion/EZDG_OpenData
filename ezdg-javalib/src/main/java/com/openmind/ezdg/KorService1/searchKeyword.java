...
public class searchKeyword {
    ...
    * 한페이지결과수
    */
    public searchKeyword numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public searchKeyword pageNo(Number pageNo) {
    ...
    */
    public searchKeyword MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public searchKeyword MobileApp(String MobileApp) {
    ...
    */
    public searchKeyword _type(String _type) {
    ...
    * 목록구분(Y=목록, N=개수)
    */
    public searchKeyword listYN(String listYN) {
    ...
    */
    public searchKeyword arrange(String arrange) {
    ...
    */
    public searchKeyword keyword(String keyword) {
        queryParams.append("&keyword=").append(encode(keyword));
        return this;
    }
    ...
    */
    public searchKeyword contentTypeId(String contentTypeId) {
    ...
    * 지역코드(지역코드조회 참고)
    */
    public searchKeyword areaCode(String areaCode) {
    ...
    * 시군구코드(지역코드조회 참고)
    */
    public searchKeyword sigunguCode(String sigunguCode) {
    ...
    * 대분류(서비스분류코드조회 참고)
    */
    public searchKeyword cat1(String cat1) {
    ...
    * 중분류(서비스분류코드조회 참고)
    */
    public searchKeyword cat2(String cat2) {
    ...
    * 소분류(서비스분류코드조회 참고)
    */
    public searchKeyword cat3(String cat3) {
        queryParams.append("&cat3=").append(encode(cat3));
        return this;
    }

    public searchKeyword (String serviceKey) {
    ...
    * API 호출 및 응답 파싱
    */
    public searchKeywordResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), searchKeywordResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
