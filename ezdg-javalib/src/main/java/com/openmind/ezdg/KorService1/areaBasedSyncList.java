...
public class areaBasedSyncList {
    ...
    * 한페이지결과수
    */
    public areaBasedSyncList numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public areaBasedSyncList pageNo(Number pageNo) {
    ...
    */
    public areaBasedSyncList MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public areaBasedSyncList MobileApp(String MobileApp) {
        queryParams.append("&MobileApp=").append(encode(MobileApp));
        return this;
    }

    public areaBasedSyncList (String serviceKey) {
    ...
    */
    public areaBasedSyncList _type(String _type) {
    ...
    * 컨텐츠표출여부(1=표출, 0=비표출)
    */
    public areaBasedSyncList showflag(String showflag) {
        queryParams.append("&showflag=").append(encode(showflag));
        return this;
    }
    ...
    */
    public areaBasedSyncList modifiedtime(String modifiedtime) {
    ...
    * 목록 구분 (Y=목록, N=개수)
    */
    public areaBasedSyncList listYN(String listYN) {
    ...
    */
    public areaBasedSyncList arrange(String arrange) {
    ...
    */
    public areaBasedSyncList contentTypeId(String contentTypeId) {
    ...
    * 지역코드(지역코드조회 참고)
    */
    public areaBasedSyncList areaCode(String areaCode) {
    ...
    * 시군구코드(지역코드조회 참고)
    */
    public areaBasedSyncList sigunguCode(String sigunguCode) {
    ...
    * 대분류 코드(서비스분류코드조회 참고)
    */
    public areaBasedSyncList cat1(String cat1) {
    ...
    * 중분류 코드(서비스분류코드조회 참고)
    */
    public areaBasedSyncList cat2(String cat2) {
    ...
    * 소분류 코드(서비스분류코드조회 참고)
    */
    public areaBasedSyncList cat3(String cat3) {
    ...
    * API 호출 및 응답 파싱
    */
    public areaBasedSyncListResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), areaBasedSyncListResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
