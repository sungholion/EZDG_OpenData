...
public class detailIntro {
    ...
    */
    public detailIntro MobileOS(String MobileOS) {
    ...
    * 서비스명(어플명)
    */
    public detailIntro MobileApp(String MobileApp) {
    ...
    */
    public detailIntro _type(String _type) {
    ...
    * 콘텐츠ID
    */
    public detailIntro contentId(String contentId) {
    ...
    */
    public detailIntro contentTypeId(String contentTypeId) {
    ...
    * 한페이지결과수
    */
    public detailIntro numOfRows(Number numOfRows) {
    ...
    * 페이지번호
    */
    public detailIntro pageNo(Number pageNo) {
        queryParams.append("&pageNo=").append(encode(pageNo));
        return this;
    }

    public detailIntro (String serviceKey) {
    ...
    * API 호출 및 응답 파싱
    */
    public detailIntroResponse fetch() {
        ...
        try {
            ...
            return objectMapper.readValue(content.toString(), detailIntroResponse.class);
        } catch (Exception e) {
            e.printStackTrace();
