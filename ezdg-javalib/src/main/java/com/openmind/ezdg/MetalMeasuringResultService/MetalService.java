...
public class MetalService {
    ...
    */
    public MetalService date(String date) {
        queryParams.append("&date=").append(Encoder.encode(date));
        return this;
    }
    ...
    */
    public MetalService stationcode(String stationcode) {
        queryParams.append("&stationcode=").append(Encoder.encode(stationcode));
        return this;
    }
    ...
    */
    public MetalService timecode(String timecode) {
        queryParams.append("&timecode=").append(Encoder.encode(timecode));
        return this;
    }
