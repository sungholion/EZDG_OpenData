...
public class WthrDataList {
    ...
    */
    public WthrDataList dataCd(String dataCd) {
        queryParams.append("&dataCd=").append(Encoder.encode(dataCd));
        return this;
    }
    ...
    */
    public WthrDataList dateCd(String dateCd) {
        queryParams.append("&dateCd=").append(Encoder.encode(dateCd));
        return this;
    }
    ...
    */
    public WthrDataList startDt(String startDt) {
        queryParams.append("&startDt=").append(Encoder.encode(startDt));
        return this;
    }
    ...
    */
    public WthrDataList startHh(String startHh) {
        queryParams.append("&startHh=").append(Encoder.encode(startHh));
        return this;
    }
    ...
    */
    public WthrDataList endDt(String endDt) {
        queryParams.append("&endDt=").append(Encoder.encode(endDt));
        return this;
    }
    ...
    */
    public WthrDataList endHh(String endHh) {
        queryParams.append("&endHh=").append(Encoder.encode(endHh));
        return this;
    }
    ...
    */
    public WthrDataList stnIds(String stnIds) {
        queryParams.append("&stnIds=").append(Encoder.encode(stnIds));
        return this;
    }
